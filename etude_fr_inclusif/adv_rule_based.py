...
class AdvRBModel(AnnPredModel):
    ...
    """
    proc : the list of processes to detect in documents among the following :
    'fle' for inflections, 'neu' for neutral-gender, 'fem' for feminisation,
    'epi' for epicene words
    """

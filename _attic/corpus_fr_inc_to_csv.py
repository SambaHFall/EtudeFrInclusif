...
"""
Produce etude_fr_inclusif/data/fr_inclusif.csv, which contains all the information from the corpus français inclusif database that are necessary for the testing of our models
"""
...
with open(sur_script_dir + "/etude_fr_inclusif/data/fr_inclusif.csv", 'w') as f :
